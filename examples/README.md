...
| [`deliberate_failure.py`](deliberate_failure.py) | Task is impossible on purpose. Shows what error capture looks like — trace status=`error`, offending step highlighted red, full DOM available for post-mortem. |
